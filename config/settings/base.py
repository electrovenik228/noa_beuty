...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-$6miewn%e4+isgb!8q6m=d$6fghs$)4q780rcl9*f@e=5_oq54')
...
# Security settings (переопределяются в production.py)
